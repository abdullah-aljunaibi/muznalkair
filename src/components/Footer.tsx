...
export default function Footer() {
  return (
    <footer style={{ background: "#030D10", color: "white" }} dir="rtl">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-tajawal)", color: "rgba(255,255,255,0.6)" }}
            >
            ...
            <div className="flex items-center gap-4 mt-2">
              <a
                href="https://instagram.com/mozn_alkair"
                target="_blank"
              ...
              <a
                href="https://youtube.com/@mozn_alkair"
                target="_blank"
                rel="noopener noreferrer"
                className="transition-colors duration-200"
                aria-label="YouTube"
          ...
          <div className="flex flex-col gap-3">
            <h3
              ...
              style={{ fontFamily: "var(--font-amiri)", fontSize: "1.1rem", color: "#D4AF37" }}
            >
              روابط سريعة
            </h3>
            {[
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              style={{ fontFamily: "var(--font-tajawal)", color: "#25D366", textDecoration: "none" }}
        ...
        {/* Divider + Copyright */}
        <div
          className="mt-10 pt-6 text-center flex flex-col gap-2"
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.8rem", fontFamily: "var(--font-tajawal)" }}>
            صُمّم وطُوِّر بواسطة{" "}
            <a
              href="https://bxb-om.com"
              target="_blank"
              rel="noopener noreferrer"
